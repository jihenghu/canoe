...
ax[1, 0].set_xlabel("qNH3 [ppmv]",fontsize=fts)
ax[1, 0].set_ylabel("Temperature [K]",fontsize=fts)
# ax[1, 0].set_xlim([0, 700])

corner.hist2d(flattened_chain[:, 0], flattened_chain[:, 2], ax=ax[2, 0])
ax[2, 0].set_xlabel("qNH3 [ppmv]",fontsize=fts)
ax[2, 0].set_ylabel("RH_max_NH3",fontsize=fts)
# ax[2, 0].set_xlim([0, 700])

corner.hist2d(flattened_chain[:, 1], flattened_chain[:, 2], ax=ax[2, 1])
ax[2, 1].set_xlabel("Temperature [K]",fontsize=fts)
ax[2, 1].set_ylabel("RH_max_NH3",fontsize=fts)
# ax[2, 1].set_xlim([0, 700])


corner.hist2d(flattened_chain[:, 0], flattened_chain[:, 3], ax=ax[3, 0])
ax[3, 0].set_xlabel("qNH3 [ppmv]",fontsize=fts)
ax[3, 0].set_ylabel("adlnNH3/lnP",fontsize=fts)
# ax[3, 0].set_xlim([0, 700])


corner.hist2d(flattened_chain[:, 1], flattened_chain[:, 3], ax=ax[3, 1])
ax[3, 1].set_xlabel("Temperature [K]",fontsize=fts)
ax[3, 1].set_ylabel("adlnNH3/lnP",fontsize=fts)
# ax[3, 1].set_xlim([0, 700])


corner.hist2d(flattened_chain[:, 2], flattened_chain[:, 3], ax=ax[3, 2])
ax[3, 2].set_xlabel("RH_max_NH3",fontsize=fts)
ax[3, 2].set_ylabel("adlnNH3/lnP",fontsize=fts)
# ax[3, 2].set_xlim([0, 700])


corner.hist2d(flattened_chain[:, 0], flattened_chain[:, 4], ax=ax[4, 0])
ax[4, 0].set_xlabel("qNH3 [ppmv]",fontsize=fts)
ax[4, 0].set_ylabel("Pmax [bar]",fontsize=fts)
# ax[4, 0].set_xlim([0, 700])

corner.hist2d(flattened_chain[:, 1], flattened_chain[:, 4], ax=ax[4, 1])
ax[4, 1].set_xlabel("Temperature [K]",fontsize=fts)
ax[4, 1].set_ylabel("Pmax [bar]",fontsize=fts)
# ax[4, 1].set_xlim([0, 700])

corner.hist2d(flattened_chain[:, 2], flattened_chain[:, 4], ax=ax[4, 2])
ax[4, 2].set_xlabel("RH_max_NH3",fontsize=fts)
ax[4, 2].set_ylabel("Pmax [bar]",fontsize=fts)
# ax[4, 2].set_xlim([0, 700])

corner.hist2d(flattened_chain[:, 3], flattened_chain[:, 4], ax=ax[4, 3])
ax[4, 3].set_xlabel("adlnNH3/lnP",fontsize=fts)
ax[4, 3].set_ylabel("Pmax [bar]",fontsize=fts)
...
for i in range(5):
    ...
    ax[i, i].set_xlabel(labels[i],fontsize=fts)
...
plt.tight_layout()
# Show the plot
plt.savefig("run_mcmc_cpcs_noch2_1000.png")
